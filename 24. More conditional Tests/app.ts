...
let Firstname :string = "aliza";
let age : number = 20;
let luckyNumbers: number[] = [1,2,3,4]
...
console.log("Is age <= 15? I pridict False." );
console.log( age <= 15);

// Logical Operators
// Test 11 AND (False)
console.log("Is 20 < age < 30 ? I pridict False." );
console.log( age < 20 && age > 30);

// Test 12 OR (True)
console.log("Is age > 5 || age < 15 ? I pridict True." );
